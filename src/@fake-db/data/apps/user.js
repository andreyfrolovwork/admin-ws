  ...
  users: [
    {
      ...
      zip_code: 'xxx',
      blue: [
        { user: 'glebanya', kills: 12, death: 4, assists: 4, points: 42},
        { user: 'daviinchii', kills: 12, death: 0, assists: 4, points: 42},
        { user: 'tosha', kills: 2, death: 2, assists: 42, points: 21},
      ],
      white: [
        { user: 'glebanya', kills: 12, death: 4, assists: 4, points: 42},
        { user: 'daviinchii', kills: 12, death: 0, assists: 4, points: 42},
        { user: 'tosha', kills: 2, death: 2, assists: 4, points: 42},
      ],
    },
  ],
}
