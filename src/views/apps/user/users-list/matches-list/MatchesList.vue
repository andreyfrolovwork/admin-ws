  ...
  <div>
    ...
    <b-card no-body class="mb-0">
      ...
      <b-table ref="refUserListTable" class="position-relative" :items="fetchUsers" responsive :fields="tableColumns"
        ...
        <!-- Column: User -->
        <template #cell(Матчи)="data">
          <b-link :to="{ name: 'apps-matches-view', params: { id: data.item.id } }"
        ...
        <template #cell(Действия)="data">
          <b-dropdown variant="link" no-caret :right="$store.state.appConfig.isRTL">
            ...
            <b-dropdown-item :to="{ name: 'apps-matches-view', params: { id: data.item.id } }">
...
import useUsersList from './useMatchesList'
