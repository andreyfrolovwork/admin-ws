<template>
  ...
  <div>
    ...
    <task-list-add-new :is-add-new-user-sidebar-active.sync="isAddNewUserSidebarActive" :role-options="roleOptions"
    ...
    <b-card no-body class="mb-0">
          ...
          <b-col cols="12" md="6">
            <div class="d-flex align-items-center justify-content-end">
              ...
              <b-button variant="primary" @click="isAddNewUserSidebarActive = true">
                <span class="text-nowrap">Добавить задание</span>
              </b-button>
            </div>
          </b-col>
        </b-row>
      ...
      <b-table ref="refUserListTable" class="position-relative" :items="fetchUsers" responsive :fields="tableColumns"
        ...
        <template #cell(Задание)="data">
          <b-media vertical-align="center">
            <small class="font-weight-bold d-block text-nowrap">{{ data.item.username }}</small>
          </b-media>
        </template>

        <!-- Column: User -->
        <template #cell(Условие)="data">
          <b-media vertical-align="center">
            <small class="font-weight-bold d-block text-nowrap">{{ data.item.username }}</small>
          </b-media>
        </template>
...
import useUsersList from './useTasksList'
