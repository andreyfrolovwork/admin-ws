<template>
  ...
  <div>
    ...
    <b-card no-body class="mb-0">
      ...
      <b-table ref="refUserListTable" class="position-relative" :items="fetchOrders" responsive :fields="tableColumns"
        ...
        <template #cell(Товар)="data">
          <b-link :to="{ name: 'apps-orders-view', params: { id: data.item.id } }"
        ...
        <template #cell(Действия)="data">
          <b-dropdown variant="link" no-caret :right="$store.state.appConfig.isRTL">
            ...
            <b-dropdown-item :to="{ name: 'apps-orders-view', params: { id: data.item.id } }">
