    ...
    <b-card no-body class="mb-0">
      ...
      <div class="m-2">
        ...
        <b-row>
          ...
          <b-col cols="12" md="4" class="d-flex align-items-center justify-content-start mb-1 mb-md-0">
            <b-button variant="primary" v-b-modal.modal-add-static-task size="sm">Добавить static task</b-button>
          </b-col>
          <!-- Search -->
          <b-col cols="12" md="4">
      ...
      >
        ...
        <template #cell(actions)="data">
          <b-button variant="primary" v-if="data.item.isEdit" @click="$store.dispatch('staticTasks/save', data.item._id)" size="sm m-5px">
            Сохранить
          </b-button>
          <b-button variant="primary" v-if="data.item.isEdit" @click="$store.commit('staticTasks/EDIT',data.item._id)" size="sm m-5px">
            Отмена
          </b-button>
